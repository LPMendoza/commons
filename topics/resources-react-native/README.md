...
# Recursos recomendados para React Native
...
- [Using Libraries](https://reactnative.dev/docs/libraries)
- [Using TypeScript](https://reactnative.dev/docs/typescript)
- [Upgrading to new React Native versions](https://reactnative.dev/docs/upgrading)
...
- [Testing React Native Apps with Jest](https://jestjs.io/docs/es-ES/tutorial-react-native)
